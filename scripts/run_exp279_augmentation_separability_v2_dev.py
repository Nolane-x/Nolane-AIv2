...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run the EXP-279 augmentation-only fold-local cross-fitted rescue "
            "separability V2 DEVELOPMENT court"
        )
    )
    ...
    parser.add_argument("--root-seed", default="20260911-exp279-augmentation-separability-v2-dev")
...
def main() -> int:
    ...
    artifact = run_exp279_augmentation_separability_v2_court(
        ...
        json.dumps(
            {
                ...
                "successor_design_may_be_considered": artifact[
                    "successor_design_may_be_considered"
                ],
                "fresh_evaluation_lineage_consumed": artifact[
