...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the EXP-279 augmentation-only direct-counterfactual utility V3 DEVELOPMENT court"
    )
    ...
    parser.add_argument("--root-seed", default="20260911-exp279-augmentation-direct-utility-v3-dev")
...
def main() -> int:
    ...
    artifact = run_exp279_augmentation_direct_utility_v3_court(
        ...
        json.dumps(
            {
                ...
                "successor_design_may_be_considered": artifact["successor_design_may_be_considered"],
