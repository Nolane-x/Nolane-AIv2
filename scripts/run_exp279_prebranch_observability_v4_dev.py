...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the EXP-279 augmentation-only cheap pre-branch observability V4 DEVELOPMENT court"
    )
    ...
    parser.add_argument("--root-seed", default="20260911-exp279-prebranch-observability-v4-dev")
...
def main() -> int:
    ...
    artifact = run_exp279_prebranch_observability_v4_court(
        ...
        json.dumps(
            {
                ...
                "fresh_evaluation_lineage_may_be_reserved": artifact["fresh_evaluation_lineage_may_be_reserved"],
