...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the EXP-279 counterfactual delta distillation V6 DEVELOPMENT court"
    )
    ...
    parser.add_argument("--root-seed", default="20260912-exp279-counterfactual-delta-distill-v6-dev")
    ...
    parser.add_argument("--distill-lr", type=float, default=2e-3)
    parser.add_argument("--selector-steps", type=int, default=200)
    parser.add_argument("--selector-lr", type=float, default=1e-2)
