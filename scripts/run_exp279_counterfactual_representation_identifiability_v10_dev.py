...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run one frozen DEVELOPMENT-only EXP-279 V10 CRIC shard"
    )
        ...
        json.dumps(
            {
                ...
                "representation_root_classifications": {
                    key: value["root_classification"]
                    for key, value in receipt["representations"].items()
                },
