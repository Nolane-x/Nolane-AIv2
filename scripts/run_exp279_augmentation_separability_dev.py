...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run the EXP-279 augmentation-only frozen-representation rescue "
            "separability DEVELOPMENT court"
        )
    )
    ...
    parser.add_argument("--root-seed", default="20260911-exp279-augmentation-separability-dev")
...
def main() -> int:
    ...
    artifact = run_exp279_augmentation_separability_court(
        ...
        json.dumps(
            {
                ...
                "fresh_evaluation_lineage_may_be_reserved": artifact[
