...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run matched EV-E2 EXP-277 paired oracle-structure development evaluation"
    )
    ...
    parser.add_argument("--root-seed", default="20260906-exp277-paired-dev")
        ...
        json.dumps(
            {
                ...
                "match_court": exp277["match_court"],
                "development_match_status": exp277["development_match_status"],
